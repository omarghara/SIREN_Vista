...
- **path**: `model_cifar10/cifar10_spatial_warmsoftlip_prereadout_cap10_lam1.0_e5/modSiren.pth`
- **model_name**: `cifar10_spatial_warmsoftlip_prereadout_cap10_lam1.0_e5`
- **variant**: `spectral_cap`
- **epoch (best)**: 4
- **loss (best mean outer loss)**: 0.02523557653612628
