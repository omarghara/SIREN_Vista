...
- **path**: `model_cifar10/cifar10_spatial_warmsoftlip_prereadout_cap50_lam1.0_e5/modSiren.pth`
- **model_name**: `cifar10_spatial_warmsoftlip_prereadout_cap50_lam1.0_e5`
- **variant**: `spectral_cap`
- **epoch (best)**: 4
- **loss (best mean outer loss)**: 0.0019143293439458143
