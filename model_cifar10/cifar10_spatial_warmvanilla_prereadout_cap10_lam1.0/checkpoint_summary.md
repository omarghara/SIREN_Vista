...
- **path**: `model_cifar10/cifar10_spatial_warmvanilla_prereadout_cap10_lam1.0/modSiren.pth`
- **model_name**: `cifar10_spatial_warmvanilla_prereadout_cap10_lam1.0`
- **variant**: `spectral_cap`
- **epoch (best)**: 19
- **loss (best mean outer loss)**: 0.0019762241780491813
