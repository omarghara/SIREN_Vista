...
- **path**: `model_cifar10/cifar10_spatial_warmvanilla_prereadout_counter1.0_lam1e-2/modSiren.pth`
- **model_name**: `cifar10_spatial_warmvanilla_prereadout_counter1.0_lam1e-2`
- **variant**: `spectral_cap`
- **epoch (best)**: 19
- **loss (best mean outer loss)**: 0.0015000930140317626
