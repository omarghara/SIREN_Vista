...
- **path**: `model_cifar10/cifar10_spatial_warmvanilla_readout_cap50_lam1.0/modSiren.pth`
- **model_name**: `cifar10_spatial_warmvanilla_readout_cap50_lam1.0`
- **variant**: `spectral_cap`
- **epoch (best)**: 19
- **loss (best mean outer loss)**: 0.0017199471838800807
