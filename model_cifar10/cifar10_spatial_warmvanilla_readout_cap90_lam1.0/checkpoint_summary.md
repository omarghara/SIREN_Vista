...
- **path**: `model_cifar10/cifar10_spatial_warmvanilla_readout_cap90_lam1.0/modSiren.pth`
- **model_name**: `cifar10_spatial_warmvanilla_readout_cap90_lam1.0`
- **variant**: `spectral_cap`
- **epoch (best)**: 1
- **loss (best mean outer loss)**: 0.0012209915326746674
