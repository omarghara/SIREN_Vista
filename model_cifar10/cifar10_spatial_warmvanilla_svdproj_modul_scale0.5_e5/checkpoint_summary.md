...
- **path**: `model_cifar10/cifar10_spatial_warmvanilla_svdproj_modul_scale0.5_e5/modSiren.pth`
- **model_name**: `cifar10_spatial_warmvanilla_svdproj_modul_scale0.5_e5`
- **variant**: `vanilla`
- **epoch (best)**: 1
- **loss (best mean outer loss)**: 0.001417441698081069
- **num_epochs requested**: 5
- **training epoch range**: 0–4

- **svd projection**: `modul` (mode `reference_scale`, every 1)
...
- `resolved_caps`: {'modul.weight': 7.130719184875488}
- `scale`: 0.5
- `sine_cap`: None
