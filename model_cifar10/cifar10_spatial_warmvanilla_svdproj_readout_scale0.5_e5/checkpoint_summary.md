...
- **path**: `model_cifar10/cifar10_spatial_warmvanilla_svdproj_readout_scale0.5_e5/modSiren.pth`
- **model_name**: `cifar10_spatial_warmvanilla_svdproj_readout_scale0.5_e5`
- **variant**: `vanilla`
- **epoch (best)**: 4
- **loss (best mean outer loss)**: 0.0026900694855222745
- **num_epochs requested**: 5
- **training epoch range**: 0–4

- **svd projection**: `readout` (mode `reference_scale`, every 1)
...
- `resolved_caps`: {'siren.hidden2rgb.weight': 0.09122159332036972}
- `scale`: 0.5
- `sine_cap`: None
